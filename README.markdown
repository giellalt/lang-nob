...
This directory contains source files for the Norwegian Bokmål language
...
-   <https://giellalt.uit.no/lang/nob/j-nob.html> (analyser)
...
The Norwegian Bokmål language sources can be acquired using [giella SVN
